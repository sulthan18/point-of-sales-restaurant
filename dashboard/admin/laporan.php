<div class="container mt-3">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <a href="admin/semua_laporan.php" target="_blank" class="btn btn-primary btn-sm mb-3">Print semua laporan <i
                ...
                foreach ($transaksi as $row):
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Rp.
                                <?= rupiah($row['hartot_transaksi']) ?>
                            </td>
                            <td>
                                <?= $row['diskon_transaksi'] ?>%
                            </td>
                            <td>Rp.
                                <?= rupiah($row['totbar_transaksi']) ?>
                            </td>
                            <td>
                                <a href="admin/print_struk.php?id_order=<?= $row['id_order'] ?>" target="_blank"
                                    class="btn btn-primary text-white btn-sm text-small"><i class="fas fa-print"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
