...
<div class="container mt-3">
	<div class="card bg-success text-white border-success mb-3">
		<div class="row no-gutters">
			...
			<div class="col-md-11">
				<div class="card-body">
					<h5 class="card-title">Selamat Datang
						<?= $_SESSION['level'] ?>
					</h5>
					<p class="card-text">
						<?= $_SESSION['nama_user'] ?>
		...
		<div class="col-md-6">
			<div class="card border-primary mb-3">
				<div class="row">
					...
					<div class="col-md-10">
						<div class="card-body">
							<h5 class="card-title">Total Penjualan hari ini :
								<?= $date ?>
							</h5>
							<span class="btn btn-success btn-sm text-small">
								<?= $sudah['sudah_bayar'] ?> Sudah bayar
							</span>
							<span class="btn btn-danger btn-sm text-small">
		...
		<div class="col-md-6">
			<div class="card border-primary mb-3">
				<div class="row">
					...
					<div class="col-md-10">
						<div class="card-body">
							<h5 class="card-title">Total Pendapatan hari ini :
								<?= $month; ?>
							</h5>
							<span class="btn btn-success btn-sm text-small">Rp.
								<?= rupiah($total['totbar']) ?>
							</span>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-10">
						<div class="ml-5 card-body">
							...
							<span class="btn btn-warning text-white btn-sm text-small">
								<?= $makanan['makanan'] ?> menu
							</span>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-10">
						<div class="ml-4 card-body">
							...
							<span class="btn btn-primary btn-sm text-small">
								<?= $waiter['waiter'] ?> Waiter
							</span>
							<span class="btn btn-secondary btn-sm text-small">
								<?= $kasir['kasir'] ?> Kasir
							</span>
						</div>
					</div>
					...
					<div class="col-md-10">
						<div class="ml-4 card-body">
							...
							<a href="index.php?laporan">
								<span class="btn btn-danger btn-sm text-small"><i class="fa fa-eye"></i> Lihat
									laporan</span>
							</a>
						</div>
					</div>
