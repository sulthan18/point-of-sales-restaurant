                ...
                <div class="col-md-8">
                    <?php if (isset($_GET['meja'])): ?>
                        <div class="det">
                            ...
                            <p>Tanggal Pesan :
                                <?= date('d-m-Y', $order['tanggal_order']) ?>
                            </p>
                            <p>Keterangan :
                                <?= $order['keterangan_order'] ?>
                            </p>
                        </div>
                    <?php endif ?>
                            ...
                            <tbody>
                                ...
                                foreach ($detail_order as $row):
                                    ...
                                    <tr class="text-small">
                                        ...
                                        <td>Rp.
                                            <?= rupiah($masakan['harga_masakan']) ?>
                                        </td>
                                        <td>Rp.
                                            <?= rupiah($masakan['harga_masakan'] * $row['jumlah_dorder']) ?>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                ...
                <div class="col-md-4">
                    <form action="fungsi/prosesTransaksi.php" method="POST">
                            ...
                            <select class="form-control" onchange='location=this.value' required>
                                ...
                                <?php if (isset($_GET['meja'])): ?>
                                    <?php foreach ($kursi as $kurs): ?>
                                        <option value="index.php?meja=<?= $kurs['meja_id'] ?>"
                                            <?= $kurs['meja_id'] == $_GET['meja'] ? 'selected' : '' ?>>
                                            <?= $kurs['meja_id'] ?>
                                        </option>
                                    <?php endforeach; ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="total_harga" readonly required value="<?= $toto ?>"
                                class="form-control hartot" placeholder="Total Harga">
                        </div>
                        <div class="form-group">
                            <label for="">Diskon (%)</label>
                            <input type="number" class="form-control diskon" min="0" max="100" name="diskon" value="0"
                                placeholder="Diskon ">
                        </div>
                        <div class="form-group">
                            <label for="">Total Bayar</label>
                            <input type="number" readonly class="form-control totbayar" required value="<?= $toto ?>"
                                name="total_bayar" placeholder="Total Bayar">
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="number" min="1" class="form-control uang" required name="uang"
                                        placeholder="Uang">
                                </div>
                                <div class="col-md-6">
                                    <input type="number" readonly class="form-control kembalian" required
