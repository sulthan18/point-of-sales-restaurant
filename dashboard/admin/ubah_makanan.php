	...
	<div class="row">
		<div class="col-lg-6">
			<div class="card">
				...
				<div class="card-body">
					<form action="fungsi/ubahMakanan.php?id_masakan=<?= $data['id_masakan'] ?>" method="post"
						...
						<div class="form-group">
							<label class="form-label" for="nama_masakan">Nama
								<?= $kategori; ?>
							</label>
						...
						<div class="form-group">
							...
							<div class="row">
								<div class="col-md-4">
									<img src="assets/image/makanan/<?= $data['foto'] ?>" alt="makanan"
										class="img-thumbnail">
								</div>
								<div class="col-md-8">
